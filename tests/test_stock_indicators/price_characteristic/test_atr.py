...
from baikal.indicators.stock_indicators.price_characteristic import ATR, ATRConfig
from tests.utility.assertions import Assertions


def test_atr(assertions: Assertions, ohlcv_day: DataFrame[OHLCV]) -> None:
    indicator = ATR(ATRConfig())
