...
from baikal.indicators.stock_indicators.price_characteristic import BOP, BOPConfig
from tests.utility.assertions import Assertions


def test_bop(assertions: Assertions, ohlcv_day: DataFrame[OHLCV]) -> None:
    indicator = BOP(BOPConfig())
