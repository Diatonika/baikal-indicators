...
from baikal.indicators.stock_indicators.volume import PVO, PVOConfig
from tests.utility.assertions import Assertions


def test_pvo(assertions: Assertions, ohlcv_day: DataFrame[OHLCV]) -> None:
    indicator = PVO(PVOConfig())
