...
from baikal.indicators.stock_indicators.volume import CMF, CMFConfig
from tests.utility.assertions import Assertions


def test_cmf(assertions: Assertions, ohlcv_day: DataFrame[OHLCV]) -> None:
    indicator = CMF(CMFConfig())
