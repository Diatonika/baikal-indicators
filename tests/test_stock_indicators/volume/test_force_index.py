...
from baikal.indicators.stock_indicators.volume import ForceIndex, ForceIndexConfig
from tests.utility.assertions import Assertions


def test_force_index(assertions: Assertions, ohlcv_day: DataFrame[OHLCV]) -> None:
    indicator = ForceIndex(ForceIndexConfig())
