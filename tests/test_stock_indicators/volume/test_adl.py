...
from baikal.indicators.stock_indicators.volume import ADL, ADLConfig
from tests.utility.assertions import Assertions


def test_adl(assertions: Assertions, ohlcv_day: DataFrame[OHLCV]) -> None:
    indicator = ADL(ADLConfig())
